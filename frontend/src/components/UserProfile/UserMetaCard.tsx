...
export default function UserMetaCard() {
  ...
  const [previewImage, setPreviewImage] = useState<string>(user?.profile_picture || "/images/user/owner.jpg");
        ...
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            <div className="w-20 h-20 overflow-hidden border border-gray-200 rounded-full dark:border-gray-800">
              <img 
                src={user?.profile_picture || "/images/user/owner.jpg"} 
                alt="user"
                onError={(e) => {
            ...
            <div className="flex items-center order-2 gap-2 grow xl:order-3 xl:justify-end">
              {/* Social links removed - they were hardcoded */}
            </div>
          </div>
        ...
        <div className="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
          <div className="px-2 pr-14">
            ...
            <p className="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
              Update your profile picture and phone number.
            </p>
          </div>
